About pybroom-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybroom-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=843&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybroom-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybroom` can be installed with `conda`:
...
```
mamba install pybroom
```

It is possible to list all of the versions of `pybroom` available on your platform with `conda`:
...
```
mamba search pybroom --channel conda-forge
```
...
mamba repoquery search pybroom --channel conda-forge

# List packages depending on `pybroom`:
mamba repoquery whoneeds pybroom --channel conda-forge

# List dependencies of `pybroom`:
mamba repoquery depends pybroom --channel conda-forge
```
